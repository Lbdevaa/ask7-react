...
export default defineMessages({
  ...
  scaffoldingHeader: {
    ...
    defaultMessage: 'Строительная полимерная компания',
  },
  scaffoldingMessage: {
    id: `${scope}.scaffolding.message`,
    defaultMessage: `Корпоративный сайт для строительной компании с собственным производством! УралПолиКом занимается монтажом и продажей наливных полимерных полов.`,
  },
  feedbackHeader: {
